...
# https://zh-v2.d2l.ai/chapter_attention-mechanisms/nadaraya-waston.html#id1
...
def plot_kernel_reg(y_hat):
    ...
    d2l.plt.savefig('./images/fig6.png')
#
# # 平均汇聚(fig4.png)
...
# print(weights.unsqueeze(1).shape)  # torch.Size([2, 1, 10])
# print(values.unsqueeze(-1).shape)  # torch.Size([2, 10, 1])
